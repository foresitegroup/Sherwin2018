    ...
    <form action="<?php echo get_template_directory_uri(); ?>/ajax-find-rep.php" method="POST" id="find-rep">
      <div class="select">
        <select name="state" id="state">
          ...
          <option value="Southwest">Arizona</option>
          ...
          <option value="Northwest">Idaho</option>
          ...
          <option value="Southwest">Nevada</option>
          <option value="NoRep">New Hampshire</option>
          <option value="NoRep">New Jersey</option>
          <option value="Southwest">New Mexico</option>
          ...
          <option value="Northwest">Oregon</option>
          ...
          <option value="Southwest">Utah</option>
          <option value="NoRep">Vermont</option>
          <option value="Virginia">Virginia </option>
          <option value="Northwest">Washington</option>
          <option value="Virginia">West Virginia</option>
          <option value="Wisconsin">Wisconsin</option>
          <option value="Northwest">Wyoming</option>
